...
type (
	...
	txpFun func(tx *Session, params ...any) (err error)
)
...
func (t *Transaction) Do(fun txFun, fields ...gox.Field[any]) (err error) {
	return t.do(func(tx *Session) error {
		return fun(tx)
	}, fields...)
}

func (t *Transaction) Dop(fun txpFun, params []any, fields ...gox.Field[any]) (err error) {
	return t.do(func(tx *Session) error {
